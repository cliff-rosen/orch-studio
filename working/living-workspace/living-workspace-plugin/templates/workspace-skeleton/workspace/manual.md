...
Append to `log.md` (in the project root, not inside `workspace/`) when:
...
- Surface it during reviews. The user decides whether to evolve a contract or leave it as escape.
...
*This is the universal default manual. A blueprint may layer on additional substrate-specific opinions when scaffolded.*
